...
class _FeeDetailsScreenState extends State<FeeDetailsScreen> {
  ...
  double _calculateTotalAmountToPay() {
    double total = 0;
    _selectedFeeIds.forEach((key, value) {
      if (_controllers[key]?.text.isNotEmpty ?? false) {
        total += double.tryParse(_controllers[key]!.text) ?? 0;
      }
    });
    return total;
  }
        ...
        children: [
                ...
                return Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: ExpansionTile(
                      ...
                      title: Text(
                        '${feeDetail['feeName']} - Due: ${feeDetail['dueAmount']}',
                        style: TextStyle(
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'Total: ${_calculateTotalAmountToPay()}',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 18.0,
                    color: Colors.black,
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    print('Paying total amount: ${_calculateTotalAmountToPay()}');
                  },
                  child: Text('Pay All'),
                  style: ElevatedButton.styleFrom(
                    foregroundColor: Colors.white,
